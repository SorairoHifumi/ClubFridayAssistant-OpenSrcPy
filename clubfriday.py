...
import datetime
import asyncio
token = 'intentionally left out' #put token here
colorlib = {
'yellow' : 0xffff8a,
'red' :0xff9999,
'green' : 0xadff2f,
...
"""),
discord.Embed(title='Calculator Commands',color=colorlib['green'],description="""
`<calc [a] [+,-,*,/,^] [b]`
...
async def version(ctx):
	await ctx.send('Running Version : v1.3.3 Serv2')
